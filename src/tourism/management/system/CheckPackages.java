...
public class CheckPackages extends JFrame{
    ...
    CheckPackages(){
        ...
        String[] package3={"BRONZE PACKAGE", "6 Days and 5 Nights", "Return Airfare", "Free Clubbing, Horse Riding nd Other Games","River Rafting", "Hard drinks free", "Daily Buffet", "BBQ Buffet", "BOOK NOW","WINTER SPECIAL", "Rs 32000/-", "package3.jpg"};
